...
class EventAction : public G4UserEventAction
{
    ...
    public:
        ...
        //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
        void AddElectronEn(G4int copyNo, G4double edep)
        {
            fHistoManager_Event->fParticleInfo.fPCBID.push_back(copyNo);
            fHistoManager_Event->fParticleInfo.fPCBEnDep.push_back(edep);
        }
        //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
        ...
        void AddAbsorberEnDep(G4int copyNo,G4double edep){
            for(size_t i_copyNo=0; i_copyNo!=(fHistoManager_Event->fParticleInfo.fAbsorberID.size()); ++i_copyNo){
                if(fHistoManager_Event->fParticleInfo.fAbsorberID.at(i_copyNo)==copyNo){
                    fHistoManager_Event->fParticleInfo.fAbsorberEnDep.at(i_copyNo) =  fHistoManager_Event->fParticleInfo.fAbsorberEnDep.at(i_copyNo) + edep;
                    return;
                }
            }
            fHistoManager_Event->fParticleInfo.fAbsorberID.push_back(copyNo);
            fHistoManager_Event->fParticleInfo.fAbsorberEnDep.push_back(edep);
        }
        ...
        void AddPCBEnDep(G4int copyNo,G4double edep){
            for(size_t i_copyNo=0; i_copyNo!=(fHistoManager_Event->fParticleInfo.fPCBID.size()); ++i_copyNo){
                if(fHistoManager_Event->fParticleInfo.fPCBID.at(i_copyNo)==copyNo){
                    fHistoManager_Event->fParticleInfo.fPCBEnDep.at(i_copyNo) =  fHistoManager_Event->fParticleInfo.fPCBEnDep.at(i_copyNo) + edep;
                    return;
                }
            }
            fHistoManager_Event->fParticleInfo.fPCBID.push_back(copyNo);
